...
module.exports = __webpack_require__("pBs8");
...
const cartsEffect_1 = __importDefault(__webpack_require__("l1dP"));
...
let ProductsList = class ProductsList extends react_1.default.Component {
  ...
  render() {
    ...
    console.log('Products List Props', this.props); //let products=JSON.stringify(this.props.products)
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(cartsEffect_1.default, {
        products: products,
...
ProductsList = __decorate([mobx_react_1.inject('store'), mobx_react_1.observer], ProductsList);
...
const Product_1 = __webpack_require__("+Gv+");
...
const style_1 = __webpack_require__("shis");
...
const CartsEffect = mobx_react_1.observer(props => {
  ...
  function items(c) {
    ...
    if (events.length) {
      ...
      return /*#__PURE__*/_reactJsxRuntime.jsx(spinner_style_1.Spinner, {});
    }
  }
  ...
  return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
    children: /*#__PURE__*/_reactJsxRuntime.jsx(style_1.GridContainer, {
      children: springs.map(({
        ...
        textEmphasisStyle,
        textIndent
      }, i) => /*#__PURE__*/_reactJsxRuntime.jsxs(style_1.AnimatedItem, {
        background: items[i].image.sourceUrl,
        onClick: () => {
          setIndex(i);
          setIsDelayed(false);
        },
        children: [currentUrl.includes('shop') || currentUrl.includes('products') ? /*#__PURE__*/_reactJsxRuntime.jsx(style_1.AnimatedItem, {
          background: `url(${items[i].image.sourceUrl}?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)`,
          style: {
            opacity,
            transform
          },
          children: /*#__PURE__*/_reactJsxRuntime.jsx(style_1.TitleWrapper, {
            style: {
              opacity: overflow
            },
        ...
        }) : /*#__PURE__*/_reactJsxRuntime.jsx(style_1.AnimatedItem, {
          background: `url(${items[i].image.node.sourceUrl}?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)`,
          style: {
            opacity,
            transform
          },
        ...
        }), /*#__PURE__*/_reactJsxRuntime.jsx(style_1.TextWrapper, {
          style: {
            height: textIndent
          },
          children: /*#__PURE__*/_reactJsxRuntime.jsxs(style_1.AnimatedBox, {
            style: {
              opacity: textEmphasisStyle
            },
            p: 2,
            children: [/*#__PURE__*/_reactJsxRuntime.jsx(Typography_1.H6, {
              children: items[i].date
            }), /*#__PURE__*/_reactJsxRuntime.jsx(style_1.DetailsBlog, {
              dangerouslySetInnerHTML: {
                __html: items[i].excerpt
              }
            })]
          })
        })]
...
const wp_query_product_1 = __webpack_require__("GSOC");

const productsList_1 = __importDefault(__webpack_require__("6zPw"));
...
const Shop = ({
  ...
  const {
    ...
    error,
    data
  } = react_apollo_1.useQuery(wp_query_product_1.GetFirstLevelproducts, {
  ...
  if (data) {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(mainLayout_1.default, _objectSpread(_objectSpread({}, Children), {}, {
        ...
        children: /*#__PURE__*/_reactJsxRuntime.jsx(productsList_1.default, {
...
const image_1 = __importDefault(__webpack_require__("Aiso"));
...
`;
exports.SingleContentGrid = theme_1.default(image_1.default)`
  display: grid;
