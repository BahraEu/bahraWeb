...
module.exports = require("@material-ui/icons/CategoryRounded");
...
const theme_2 = __webpack_require__("izHv");
...
const styled_1 = __webpack_require__("85Yr");
...
const Avatar = props => {
  ...
  return /*#__PURE__*/_reactJsxRuntime.jsxs(styled_1.StyledAvatar, {
    src: src,
    size: size,
    style: style,
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(styled_1.StyledImage, {
      src: src
    }), /*#__PURE__*/_reactJsxRuntime.jsx(styled_1.StyledText, {
      size: size,
      children: initials
    })]
  });
...
module.exports = __webpack_require__("267u");
...
const wp_query_artist_1 = __webpack_require__("UAFY");

const mainLayout_1 = __importDefault(__webpack_require__("DlTA"));

const artistList_1 = __importDefault(__webpack_require__("zWkD"));
...
const ArtistsPage = ({
  ...
  const {
    ...
    error,
    data
  } = react_apollo_1.useQuery(wp_query_artist_1.GetFirstLevelArtist, {
    notifyOnNetworkStatusChange: true
  });
  if (loading) return /*#__PURE__*/_reactJsxRuntime.jsx(spinner_1.default, {});
  if (error) return `Error! ${error.message}`;

  if (data) {
    let artistsItems = data.artists.items;
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(mainLayout_1.default, _objectSpread(_objectSpread({}, Children), {}, {
        currentUrl: currentUrl,
        currentLanguage: currentLanguage,
        artists: artistsItems,
        children: /*#__PURE__*/_reactJsxRuntime.jsx(artistList_1.default, {
          artists: artistsItems,
          currentUrl: currentUrl,
          currentLanguage: currentLanguage
        })
...
const styles_1 = __webpack_require__("h0vj");

const react_1 = __importStar(__webpack_require__("cDcd"));

const TagsIcon_1 = __importDefault(__webpack_require__("IXZ1"));
...
class TagC extends react_1.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.GridContainer, {
        active: isActive,
        children: /*#__PURE__*/_reactJsxRuntime.jsx(TagsIcon_1.default, {})
      })
    });
  }
...
const style_1 = __webpack_require__("sONa");

const BlankFooter_1 = __importDefault(__webpack_require__("gAiN"));

const mainLayoutStyle_1 = __webpack_require__("qHM2");

const ToolsBar_1 = __importDefault(__webpack_require__("jR0U"));
...
let MainLayout = class MainLayout extends React.Component {
  constructor(props) {
    ...
    this.hadelStore = currentUrl => {
      ...
      if (currentUrl.includes('event' || false)) {
      ...
      if (currentUrl.includes('artist' || false)) {
  ...
  render() {
    ...
    const {
      ...
      tags,
      categories
    } = this.state; // let activeRoute = BahaRouter(this.props.currentUrl);

    debugger;
    console.log('MainLayout', this.props); // const tags=this.state.artists.map
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
      ...
      }), /*#__PURE__*/_reactJsxRuntime.jsxs(mainLayoutStyle_1.MainLayoutContainer, {
        children: [/*#__PURE__*/_reactJsxRuntime.jsx(mobileNav_1.default, {
          currentUrl: currentUrl,
          ...
          currentUrl: currentUrl,
          currentLanguage: this.props.currentLanguage
        }), /*#__PURE__*/_reactJsxRuntime.jsx(style_1.PageInfo, {
          container: true,
          id: "BAHRA"
        }), /*#__PURE__*/_reactJsxRuntime.jsxs(mainLayoutStyle_1.InnerGrid, {
          children: [/*#__PURE__*/_reactJsxRuntime.jsx(mainLayoutStyle_1.MainLayoutContent, {
            item: true,
            xl: 10,
            lg: 10,
            md: 10,
            xs: 10,
            sm: 10,
            children: /*#__PURE__*/_reactJsxRuntime.jsx(mainLayoutStyle_1.StyledMainPaper, {
              children: this.props.children
            })
          }), /*#__PURE__*/_reactJsxRuntime.jsx(mainLayoutStyle_1.MainToolsBarContent, {
            item: true,
            open: toolBarOpen,
            ref: this.sideBarRef,
            onClick: () => this.toggletoolBarOpen(!toolBarOpen),
            ...
            xs: 2,
            sm: 2,
            children: /*#__PURE__*/_reactJsxRuntime.jsx(ToolsBar_1.default, {
              toolBarOpen: toolBarOpen,
              tags: tags,
              categories: categories,
              currentUrl: currentUrl,
              currentLanguage: this.props.currentLanguage,
              bahraContent: bahraContent
            })
          })]
        }), /*#__PURE__*/_reactJsxRuntime.jsx(BlankFooter_1.default, {
          fromFullYear: 2020,
          currentUrl: currentUrl
        })]
      })]
...
MainLayout = __decorate([mobx_react_1.inject('store'), mobx_react_1.observer], MainLayout);
;
...
const RemoveCircleRounded_1 = __importDefault(__webpack_require__("LLhV"));

const AddCircle_1 = __importDefault(__webpack_require__("mZPz"));

const core_1 = __webpack_require__("KKbo");

const Card_1 = __importDefault(__webpack_require__("ynkv"));
...
const Body = props => {
  ...
  if (isLoading) return /*#__PURE__*/_reactJsxRuntime.jsx(spinner_style_1.Spinner, {});
...
const styles_1 = __webpack_require__("zBZg");

const StyledIconTags = props => {
  console.log(props);
  const t = props.t;
  return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(styles_1.LocalOfferStyledIcon, {}), /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.Label, {
      children: t('Tags')
    })]
  });
};
...
module.exports = require("@material-ui/icons/RemoveCircleRounded");
...
const styled_1 = __webpack_require__("6rUp");
...
const HeaderTitle = props => {
  ...
  if (typeof children === 'string' || typeof children === 'number') {
    return /*#__PURE__*/_reactJsxRuntime.jsx(styled_1.TextTitle, {
...
const StyledIconCategory = props => {
  ...
  const t = props.t;
  return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(styles_1.CategoryStyledIcon, {}), /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.Label, {
      children: t('Category')
    })]
  });
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/svg+xml;base64,");
...
const checkoutIcon_1 = __importDefault(__webpack_require__("k3Z+"));

const styles_1 = __webpack_require__("LYqf");
  ...
  render() {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsxs("section", {
      ...
      children: [/*#__PURE__*/_reactJsxRuntime.jsx("h2", {
        children: "Your cart"
      }), /*#__PURE__*/_reactJsxRuntime.jsx("section", {
        className: "Page-cart-items",
        children: cart.entries.map(entry => /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
          children: /*#__PURE__*/_reactJsxRuntime.jsx(CartEntry, {
            shop: shop,
            entry: entry
          }, entry.product.id)
        }))
      }), /*#__PURE__*/_reactJsxRuntime.jsxs("p", {
        children: ["Subtotal: ", cart.subtotal, " \u20AC"]
      }), cart.hasDiscount && /*#__PURE__*/_reactJsxRuntime.jsx("p", {
        children: /*#__PURE__*/_reactJsxRuntime.jsxs("i", {
          children: ["Large order discount: ", cart.discount, " \u20AC"]
        })
      }), /*#__PURE__*/_reactJsxRuntime.jsx("p", {
        children: /*#__PURE__*/_reactJsxRuntime.jsxs("b", {
          children: ["Total: ", cart.total, " \u20AC"]
        })
      }), /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.GridContainer, {
        active: isActive,
        children: /*#__PURE__*/_reactJsxRuntime.jsx(checkoutIcon_1.default, {
          active: isActive,
          t: t,
          toolBarOpen: toolBarOpen
        })
...
const CartEntry = mobx_react_1.inject('shop')(mobx_react_1.observer(({
  shop,
  entry
}) => /*#__PURE__*/_reactJsxRuntime.jsxs("div", {
  className: "Page-cart-item",
  children: [/*#__PURE__*/_reactJsxRuntime.jsxs("p", {
    children: [/*#__PURE__*/_reactJsxRuntime.jsx("a", {
  ...
  }), !entry.product.isAvailable && /*#__PURE__*/_reactJsxRuntime.jsx("p", {
    ...
    children: /*#__PURE__*/_reactJsxRuntime.jsxs("p", {
      children: ["Amount:", /*#__PURE__*/_reactJsxRuntime.jsx("input", {
        value: entry.quantity,
        onChange: updateEntryQuantity.bind(null, entry)
      }), "total: ", /*#__PURE__*/_reactJsxRuntime.jsxs("b", {
...
const title_1 = __importDefault(__webpack_require__("Q9zv"));
...
const Header = props => {
  const {
    ...
    icon,
    actions
  } = props; // const isShowed = !!(title || icon || actions);

  return /*#__PURE__*/_reactJsxRuntime.jsxs(styled_1.HeaderContainer, {
    children: [/*#__PURE__*/_reactJsxRuntime.jsxs(styled_1.TitleContent, {
      children: [/*#__PURE__*/_reactJsxRuntime.jsx(styled_1.Icon, {
        children: icon
      }), /*#__PURE__*/_reactJsxRuntime.jsx(title_1.default, {
        children: title
      })]
    }), actions]
  });
...
const StyledIconFilter = props => {
  ...
  const t = props.t;
  return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(styles_1.FilterListStyledIcon, {}), /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.Label, {
      children: t('Filter')
    })]
  });
};
...
const ToolBarStyles_1 = __webpack_require__("/OEj");

const category_1 = __importDefault(__webpack_require__("vsbu"));

const cart_1 = __importDefault(__webpack_require__("Yojx"));

const tag_1 = __importDefault(__webpack_require__("9TVK"));
...
const SortByIcon_1 = __webpack_require__("lrUN");

const FilterIcon_1 = __webpack_require__("iSAj");
...
let ToolsBar = class ToolsBar extends react_1.default.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
      ...
      }) : null, currentUrl.includes('blog' || false) ? /*#__PURE__*/_reactJsxRuntime.jsx(ToolBarStyles_1.StyledTopToolBarIcons, {
        children: /*#__PURE__*/_reactJsxRuntime.jsx(blogsIcon_1.default, {
          toolBarOpen: toolBarOpen
        })
      }) : null, currentUrl.includes('artist' || false) ? /*#__PURE__*/_reactJsxRuntime.jsx(ToolBarStyles_1.StyledTopToolBarIcons, {
        children: /*#__PURE__*/_reactJsxRuntime.jsx(artistsIcon_1.default, {
          toolBarOpen: toolBarOpen
        })
      }) : null, currentUrl.includes('event' || false) ? /*#__PURE__*/_reactJsxRuntime.jsx(ToolBarStyles_1.StyledTopToolBarIcons, {
        children: /*#__PURE__*/_reactJsxRuntime.jsx(eventsIcon_1.default, {
          toolBarOpen: toolBarOpen
        })
...
const CheckoutIcon = mobx_react_lite_1.observer(props => {
  const checkoutIcon = __webpack_require__("YPai");
...
const StyledIconSortBy = props => {
  ...
  const t = props.t;
  return /*#__PURE__*/_reactJsxRuntime.jsxs(_reactJsxRuntime.Fragment, {
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(styles_1.SortByAlphaStyledIcon, {}), /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.Label, {
      children: t('SortBy')
    })]
  });
};
...
exports.ArtistsWrapper = theme_1.default(core_1.Card)`
display: flex !important;
flex-direction: column !important;
align-items: center !important;
...
background: ${props => props.open ? utilty_1.hexa(props.theme.bg.inset, 0.8) : utilty_1.hexa(props.theme.bg.inset1, 0.4)} !important;
@media (max-width: ${theme_1.theme.breakpoints[0]}) {
    right:6% !important;
    top: 26% !important;
}
...
exports.Label = index_1.default.span`
    ...
    a:hover {
        background: ${props => props.active ? utilty_1.hexa(props.theme.text.link, 0.08) : utilty_1.hexa(props.theme.text.secondary, 0.04)};
    }
...
const CategoryIcon_1 = __importDefault(__webpack_require__("U1KS"));

class CategoryC extends react_1.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.GridContainer, {
        active: isActive,
        children: /*#__PURE__*/_reactJsxRuntime.jsx(CategoryIcon_1.default, {})
      })
    });
  }
...
const header_1 = __importDefault(__webpack_require__("boPW"));

const body_1 = __importDefault(__webpack_require__("HAsK"));
...
const Card = props => {
  const {
    ...
    children,
    style
  } = props; // const showFooter = !!(footer && !isLoading);

  return /*#__PURE__*/_reactJsxRuntime.jsxs(styled_1.Container, {
    style: style,
    children: [/*#__PURE__*/_reactJsxRuntime.jsx(header_1.default, {
      title: title,
      icon: icon,
      actions: actions
    }), /*#__PURE__*/_reactJsxRuntime.jsx(body_1.default, {
      isLoading: isLoading,
      children: children
    }), /*#__PURE__*/_reactJsxRuntime.jsx(styled_1.Footer, {
      children: footer
    })]
  });
};
...
const index_1 = __webpack_require__("MD2z");

const CategoryRounded_1 = __importDefault(__webpack_require__("+VW2"));

const LocalOfferRounded_1 = __importDefault(__webpack_require__("UrS4"));

const FilterListRounded_1 = __importDefault(__webpack_require__("u/0/"));

const SortByAlphaRounded_1 = __importDefault(__webpack_require__("3pwS"));
...
const style_1 = __webpack_require__("Ftca");

const styles_1 = __webpack_require__("oEpA");

const Typography_1 = __webpack_require__("MD2z");

const Avatar_1 = __importDefault(__webpack_require__("04JQ"));
...
class ArtistList extends react_1.default.Component {
  ...
  render() {
    ...
    console.log(artists);
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(style_1.ArtistsWrap, {
        children: artists.map(item => /*#__PURE__*/_reactJsxRuntime.jsx("div", {
          children: /*#__PURE__*/_reactJsxRuntime.jsx(styles_1.ArtistsWrapper, {
            children: /*#__PURE__*/_reactJsxRuntime.jsx(routes_1.Link, {
              as: `/artists/${item.slug}-${item.artistId}`,
              href: `/artists ?slug=${item.slug}-${item.artistId}`,
              children: /*#__PURE__*/_reactJsxRuntime.jsxs("a", {
                children: [/*#__PURE__*/_reactJsxRuntime.jsx(style_1.ImgWrap, {
                  children: /*#__PURE__*/_reactJsxRuntime.jsx(style_1.Img, {
                    src: item.image.node.sourceUrl
                  })
                }), /*#__PURE__*/_reactJsxRuntime.jsx(style_1.Title, {
                  children: item.title
                }), /*#__PURE__*/_reactJsxRuntime.jsx(Typography_1.H2, {
                  children: item.excerpt
                }), /*#__PURE__*/_reactJsxRuntime.jsx(Avatar_1.default, {
