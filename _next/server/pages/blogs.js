...
const wp_query_blog_1 = __webpack_require__("VDhn");

const mainLayout_1 = __importDefault(__webpack_require__("DlTA"));

const blogList_1 = __importDefault(__webpack_require__("u+/1"));
...
const BlogsPage = ({
  ...
  const {
    ...
    error,
    data
  } = react_apollo_1.useQuery(wp_query_blog_1.GetFirstLevelPosts);
  ...
  if (data) {
    ...
    return /*#__PURE__*/_reactJsxRuntime.jsx(_reactJsxRuntime.Fragment, {
      children: /*#__PURE__*/_reactJsxRuntime.jsx(mainLayout_1.default, {
        ...
        children: /*#__PURE__*/_reactJsxRuntime.jsx(blogList_1.default, {
          Blogs: Posts,
          currentUrl: currentUrl,
          currentLanguage: currentLanguage
        })
...
module.exports = __webpack_require__("+fi+");
